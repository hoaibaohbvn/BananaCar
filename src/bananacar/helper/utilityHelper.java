...
public class utilityHelper {
    ...
    a-z, A-Z, 0-9
     */
    public static boolean checkMaHang(JTextField txt) {
        txt.setBackground(white);
        String id = txt.getText();
        String rgx = "[a-zA-Z0-9]{1,10}";
        if (id.matches(rgx)) {
...
//        }
    ...
    //bất kì kí tự nào
    //từ 3-255 kí tự
//    public static boolean checkMoTaCD(JEditorPane txt) {
//        txt.setBackground(white);
//        String id = txt.getText();
//        String rgx = ".{3,255}";
//        if (id.matches(rgx)) {
...
//    }
    ...
    public static boolean checkNullDate(JDateChooser txt) {
        txt.setBackground(white);
        String date = String.valueOf(txt.getDate());
        if (!date.equals(null)) {
            return true;
        } else {
            txt.setBackground(pink);
    ...
    public static boolean checkNullText(JEditorPane txt) {
        txt.setBackground(white);
        if (txt.getText().trim().length() > 0) {
            return true;
        } else {
